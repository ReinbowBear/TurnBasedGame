...
public class ClickCharacter : MonoBehaviour
{
    ...
    void OnEnable()
    {
        GameKeyboard.gameInput.Player.Mouse_0.started += ClickSomeone;
        GameKeyboard.gameInput.Player.Mouse_1.started += DropCharacter;
        
        GameKeyboard.gameInput.Player.Slot_1.started += context => ChooseAbility(0);
        GameKeyboard.gameInput.Player.Slot_2.started += context => ChooseAbility(1);
    }
